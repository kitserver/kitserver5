...
#define MODID 103
#define NAMELONG "Faceserver 5.7.2.4"
...
enum {NUM_FACES_ARRAY,STDW,STDY,STDR,STDK,STARTW,STARTY,STARTR,STARTK,
	...
	PLAYERS_LINEUP, FACES_LINEUP, HAIRS_LINEUP, PLAYERID_IN_PLAYERDATA, PLAYERDATA_SIZE, ISEDITMODE,
	};
...
DWORD fIDsArray[][FIDSLEN] = {
	//PES5
	{
		...
		0x84eeb0,0xaca9e9,
		0x3bcfb10,0x3be3140,0x3be31e0,0x3bd3e00,0x344,0x38f97f8,
	},
	//WE9
	{
		0x393e27c,265,139,57,32,1954,2219,1897,1865,
		...
		0x84f360,0xacaca9,
		0x3bcfb30,0x3be3160,0x3be3200,0x3bd3e20,0x344,0x38f97f8,
	},
	//WE9:LE
	{
		...
		0x876610,0xaca619,
		0x3b57650,0x3b6ac80,0x3b6ad20,0x3b5b940,0x344,0x3834108,
	}
};
